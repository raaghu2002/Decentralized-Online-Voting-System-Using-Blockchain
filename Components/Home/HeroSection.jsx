      ...
      <div class="container pt-20 mt-12 mt-lg-20">
        <div class="row pt-4 pt-lg-10 gy-12 gy-lg-0 justify-content-center justify-content-lg-between align-items-center">
            ...
            <div class="hero-card p1-xxl-bg pt-xl-20 pb-xl-20 position-relative">
              <div class="pt-xxl-10 pb-xxl-10">
                <div class="circle-text first d-center cus-z1 position-absolute end-0 top-0 d-none d-xxl-flex me-lg-10 mt-lg-10">
                  <div class="text d-center" style={{ color: "white" }}>
                    <p class="fs-six" style={{ color: "white" }}>
                      Secure Voting 
                    </p>
                  </div>
                  <img
                ...
                <span
                  class="heading p1-max-xxl nb4-xxl-color fs-five mb-3"
                  style={{ color: "white" }}
                >
                  Decentralized Voting
                </span>
                <h1
                  class="display-two nb4-xxl-color mb-5 mb-lg-6"
                  style={{ color: "white" }}
                >
                  Vote For MITM President
                </h1>
                <p
                  class="fs-six-up fw_500 nb4-xxl-color"
                  style={{ color: "white" }}
                >
                  Now you can ellected your first MITM president through the
                ...
                {initialData?.startDateN != 0 &&
                  initialData?.endDateN != 0 && (
                    <>
                      <span
                        class="heading mt-3 p1-max-xxl nb4-xxl-color fs-five mb-3"
                        style={{ color: "white" }}
                      >
          ...
          <ul class="list_items col-12 d-flex row-gap-6 gap-lg-15 justify-content-between flex-wrap pt-2 pt-lg-15 pt-xl-2 pt-xxl-15 pb-15">
            <li class="d-flex gap-3 align-items-center" style={{ color: "white" }}>
              <span class="d-center s1-bg p-3 p-lg-4 rounded-circle">
                <i class="ti ti-tools fs-three nb4-color"></i>
              </span>
              <h4 class="nw1-color" style={{ color: "white" }}>Register as Voter</h4>
            </li>
            <li class="d-flex gap-3 align-items-center" style={{ color: "white" }}>
              <span class="d-center s1-bg p-3 p-lg-4 rounded-circle">
                <i class="ti ti-trending-up fs-three nb4-color"></i>
              </span>
              <h4 class="nw1-color" style={{ color: "white" }}>Candidate</h4>
            </li>
            <li class="d-flex gap-3 align-items-center" style={{ color: "white" }}>
              <span class="d-center s1-bg p-3 p-lg-4 rounded-circle">
                <i class="ti ti-broadcast fs-three nb4-color"></i>
              </span>
              <h4 class="nw1-color" style={{ color: "white" }}>Get Approvel</h4>
            </li>
            <li class="d-flex gap-3 align-items-center" style={{ color: "white" }}>
              <span class="d-center s1-bg p-3 p-lg-4 rounded-circle">
                <i class="ti ti-percentage fs-three nb4-color"></i>
              </span>
              <h4 class="nw1-color" style={{ color: "white" }}>Give Vote</h4>
            </li>
          </ul>
        </div>
      </div>
