...
const NATIVE_CURRENCY = process.env.NEXT_PUBLIC_CURRENCY;
const NATIVE_NETWORK = process.env.NEXT_PUBLIC_NETWORK;
...
export const VOTER_DAPP_PROVIDER = ({ children }) => {
  const VOTING_DAPP = DAPP_NAME;
  const currency = NATIVE_CURRENCY;
  const network = NATIVE_NETWORK;
